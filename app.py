...
def generate_docx(matrix_df, col_sums, wabak_df, harian_detail_df, vector_df, bkk_table_df, is_bkk_empty, bkk_details):
    ...
    t21.allow_autofit = False # Matikan autofit untuk kawalan manual
    
    # Penentuan lebar kolom (Total ~6.5 inci sesuai untuk margin normal 2.54cm)
    col_widths = [Inches(0.4), Inches(1.2), Inches(1.0), Inches(3.2), Inches(0.7)]
    ...
    if harian_detail_df.empty:
        ...
        merged.text = "Tiada wabak dilaporkan pada tarikh ini."
        ...
        for idx, row_data in enumerate(harian_detail_df.values, start=1):
            ...
            for c in range(5):
                ...
                # Tempat Berlaku Align Left, selebihnya Center
